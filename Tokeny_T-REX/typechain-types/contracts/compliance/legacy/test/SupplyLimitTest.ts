...
export interface SupplyLimitTestInterface extends utils.Interface {
  functions: {
    ...
    "complianceCheckOnSupplyLimit(address,address,uint256)": FunctionFragment;
    ...
    "setSupplyLimit(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "complianceCheckOnSupplyLimit",
    values: [
      PromiseOrValue<string>,
      PromiseOrValue<string>,
      PromiseOrValue<BigNumberish>
  ...
  events: {
    ...
    "SupplyLimitSet(uint256)": EventFragment;
...
export interface SupplyLimitSetEventObject {
  _limit: BigNumber;
}
export type SupplyLimitSetEvent = TypedEvent<
  [BigNumber],
  SupplyLimitSetEventObject
>;

export type SupplyLimitSetEventFilter = TypedEventFilter<SupplyLimitSetEvent>;
...
export interface SupplyLimitTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SupplyLimitTestInterface;
  ...
  filters: {
    ...
    "SupplyLimitSet(uint256)"(_limit?: null): SupplyLimitSetEventFilter;
    SupplyLimitSet(_limit?: null): SupplyLimitSetEventFilter;
