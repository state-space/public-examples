...
export interface CountryRestrictionsInterface extends utils.Interface {
  functions: {
...
export interface CountryRestrictions extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CountryRestrictionsInterface;
