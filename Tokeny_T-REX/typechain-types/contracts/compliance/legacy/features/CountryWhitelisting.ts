...
export interface CountryWhitelistingInterface extends utils.Interface {
  functions: {
...
export interface UnWhitelistedCountryEventObject {
  _country: number;
}
export type UnWhitelistedCountryEvent = TypedEvent<
  [number],
  UnWhitelistedCountryEventObject
>;

export type UnWhitelistedCountryEventFilter =
  TypedEventFilter<UnWhitelistedCountryEvent>;

export interface WhitelistedCountryEventObject {
  _country: number;
}
export type WhitelistedCountryEvent = TypedEvent<
  [number],
  WhitelistedCountryEventObject
>;

export type WhitelistedCountryEventFilter =
  TypedEventFilter<WhitelistedCountryEvent>;

export interface CountryWhitelisting extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CountryWhitelistingInterface;
  ...
  filters: {
    ...
    "UnWhitelistedCountry(uint16)"(
      _country?: null
    ): UnWhitelistedCountryEventFilter;
    UnWhitelistedCountry(_country?: null): UnWhitelistedCountryEventFilter;

    "WhitelistedCountry(uint16)"(
      _country?: null
    ): WhitelistedCountryEventFilter;
    WhitelistedCountry(_country?: null): WhitelistedCountryEventFilter;
  };
