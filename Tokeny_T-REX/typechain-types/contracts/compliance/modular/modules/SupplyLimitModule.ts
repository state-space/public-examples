...
export interface SupplyLimitModuleInterface extends utils.Interface {
  functions: {
...
export interface SupplyLimitModule extends BaseContract {
  ...
  filters: {
    ...
    "SupplyLimitSet(address,uint256)"(
      _compliance?: null,
      _limit?: null
    ): SupplyLimitSetEventFilter;
    SupplyLimitSet(
      _compliance?: null,
      _limit?: null
    ): SupplyLimitSetEventFilter;
