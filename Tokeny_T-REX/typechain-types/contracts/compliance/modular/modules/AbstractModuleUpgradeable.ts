...
export interface AbstractModuleUpgradeableInterface extends utils.Interface {
  functions: {
...
export interface AbstractModuleUpgradeable extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AbstractModuleUpgradeableInterface;
