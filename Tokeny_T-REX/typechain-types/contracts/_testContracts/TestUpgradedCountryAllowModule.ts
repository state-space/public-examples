...
export interface TestUpgradedCountryAllowModuleInterface
  ...
  functions: {
    ...
    "setNewField(uint256)": FunctionFragment;
...
export interface TestUpgradedCountryAllowModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: TestUpgradedCountryAllowModuleInterface;
  ...
  functions: {
    ...
    getNewField(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    getNewField(overrides?: CallOverrides): Promise<PopulatedTransaction>;
