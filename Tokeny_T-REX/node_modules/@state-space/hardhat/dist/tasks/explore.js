...
(0, scope_1.maybeScope)()
    .task((0, scope_1.scopedName)("explore"), "Explore state space")
    .addFlag("dry", "")
    ...
    try {
        ...
        const res = await (0, util_1.withAuth)(async () => (0, retry_1.retryNetworkErrors)(() => explore.requestExploration(true, force), spinner), creds => explore.setAuth(creds), spinner);
        if (res?.error) {
