...
export interface DayMonthLimitsTestInterface extends utils.Interface {
  functions: {
...
export interface DailyLimitUpdatedEventObject {
  _newDailyLimit: BigNumber;
}
export type DailyLimitUpdatedEvent = TypedEvent<
  [BigNumber],
  DailyLimitUpdatedEventObject
>;

export type DailyLimitUpdatedEventFilter =
  TypedEventFilter<DailyLimitUpdatedEvent>;

export interface MonthlyLimitUpdatedEventObject {
  _newMonthlyLimit: BigNumber;
}
export type MonthlyLimitUpdatedEvent = TypedEvent<
  [BigNumber],
  MonthlyLimitUpdatedEventObject
>;

export type MonthlyLimitUpdatedEventFilter =
  TypedEventFilter<MonthlyLimitUpdatedEvent>;
...
export interface DayMonthLimitsTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DayMonthLimitsTestInterface;
  ...
  functions: {
    ...
    setDailyLimit(
      _newDailyLimit: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;

    setMonthlyLimit(
      _newMonthlyLimit: PromiseOrValue<BigNumberish>,
      overrides?: Overrides & { from?: PromiseOrValue<string> }
    ): Promise<ContractTransaction>;
  ...
  filters: {
    ...
    "DailyLimitUpdated(uint256)"(
      _newDailyLimit?: null
    ): DailyLimitUpdatedEventFilter;
    DailyLimitUpdated(_newDailyLimit?: null): DailyLimitUpdatedEventFilter;

    "MonthlyLimitUpdated(uint256)"(
      _newMonthlyLimit?: null
    ): MonthlyLimitUpdatedEventFilter;
    MonthlyLimitUpdated(
      _newMonthlyLimit?: null
    ): MonthlyLimitUpdatedEventFilter;
