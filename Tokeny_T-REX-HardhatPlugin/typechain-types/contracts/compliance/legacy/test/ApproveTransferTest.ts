...
export interface ApproveTransferTestInterface extends utils.Interface {
  functions: {
...
export interface ApproveTransferTest extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ApproveTransferTestInterface;
