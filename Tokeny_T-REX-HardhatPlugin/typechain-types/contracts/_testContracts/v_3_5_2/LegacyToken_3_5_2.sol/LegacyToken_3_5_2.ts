...
export interface LegacyToken_3_5_2Interface extends utils.Interface {
  functions: {
...
export interface LegacyToken_3_5_2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LegacyToken_3_5_2Interface;
