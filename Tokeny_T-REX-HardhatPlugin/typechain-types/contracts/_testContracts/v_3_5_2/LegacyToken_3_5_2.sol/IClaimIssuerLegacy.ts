...
export interface IClaimIssuerLegacyInterface extends utils.Interface {
  functions: {
...
export interface IClaimIssuerLegacy extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IClaimIssuerLegacyInterface;
